...
void Block::calcVerts() {
    verts.resize(8);
    verts.at(0) = Vector3(-.5, .5, .5);
    verts.at(1) = Vector3(-.5, -.5, .5);
    verts.at(2) = Vector3(.5, -.5, .5);
    verts.at(3) = Vector3(.5, .5, .5);
    verts.at(4) = Vector3(.5, .5, -.5);
    verts.at(5) = Vector3(.5, -.5, -.5);
    verts.at(6) = Vector3(-.5, -.5, -.5);
    verts.at(7) = Vector3(-.5, .5, -.5);
