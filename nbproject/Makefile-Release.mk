...
${OBJECTDIR}/Protobyte/Shader.o: Protobyte/Shader.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/Shader.o Protobyte/Shader.cpp
...
${OBJECTDIR}/Protobyte/Vector3.o: Protobyte/Vector3.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/Vector3.o Protobyte/Vector3.cpp
...
${OBJECTDIR}/Protobyte/Tube.o: Protobyte/Tube.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/Tube.o Protobyte/Tube.cpp
...
${OBJECTDIR}/Protobyte/GeomBase.o: Protobyte/GeomBase.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/GeomBase.o Protobyte/GeomBase.cpp

${OBJECTDIR}/Protobyte/Matrix4.o: Protobyte/Matrix4.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/Matrix4.o Protobyte/Matrix4.cpp

${OBJECTDIR}/Protobyte/Vertex.o: Protobyte/Vertex.cpp 
	${MKDIR} -p ${OBJECTDIR}/Protobyte
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Protobyte/Vertex.o Protobyte/Vertex.cpp
